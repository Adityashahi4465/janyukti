            ...
            Expanded(
              child: RefreshIndicator(
                ...
                child: challengesAsync.when(
                  ...
                  data: (challenges) {
                    return _DashboardContent(challenges: challenges);
                  },
                ),
              ),
            ),
...
class _DashboardContent extends StatelessWidget {
  const _DashboardContent({required this.challenges});
  ...
  Widget build(BuildContext context) {
    ...
    /*
     * Keep these at 0 until their own Riverpod providers/APIs
     * are connected. Do not fabricate values in the UI.
     */
